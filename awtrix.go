...
type AwtrixApp struct {
	...
	Color       string              `json:"color,omitempty"`       //or array of integers			// The text, bar or line color
	Background  string              `json:"background,omitempty"`  // or array of integers			// Sets a background color
	...
	ProgressC   string              `json:"progressC,omitempty"`   //or array of integers // The color of the progressbar
	ProgressBC  string              `json:"progressBC,omitempty"`  //or array of integers	// The color of the progressbar background
	...
	Draw        []AwtrixDrawCommand `json:"draw,omitempty"`        //    array of objects //Array of drawing instructions. Each object represents a drawing command.
...
func postNotification(ip string, app AwtrixApp) error {
	// HTTP endpoint
	postURL := fmt.Sprintf("http://%s/api/notify", ip)
...
func postApplication(ip string, name string, app AwtrixApp) error {
	...
	log.Printf("Posting application to %s", postURL)
